...
# Extracted to dbex.geometry.crystallography (ARCH-REFACTOR-001 Phase A)
...
# ============================================================================
# ARCH-REFINE-001 Phase C.3: Physics helper extraction
# Forward simulation and loss helpers moved to dbex.physics (gradcheck-only, test-scoped)
# to decouple DB-AT-010 from the bridge monolith. Re-exported here for backward compatibility.
#
# References:
#   - docs/spec-db-core.md §§57-68 (variance-weighted chi-squared)
#   - docs/spec-db-workflow.md §§30-45 (forward helper expectations)
