...
- [ARCH-GRADIENT-FLOW-001] (Gradient Flow Restoration — DB-AT-010 Unblock) — **blocked_pending_upstream** (2025-12-08T160000Z i=189: Upstream response received (`inbox/nanobrag_torch_response_2025_12_08.md`); wavelength/distance tensor preservation fixes ARE present in editable install. DB-AT-010 re-verified: **5/5 FAIL** with Jacobian mismatches (250×-120000× magnitude, all sign flips). Upstream fixes resolved graph connectivity but NOT gradient correctness — issue is in crystallographic/physics forward pass. Crystal cell gradient magnitude issue from escalation `inbox/to_nanobrag_gradient_magnitude_2025_12_07.md` NOT addressed in response. **Blocked until:** nanobrag_torch physics/gradient computation audit. Artifacts: `plans/active/DB-AT-SUITE-CARE-001/reports/2025-12-08T160000Z/`)
...
- [DB-AT-SUITE-CARE-001] (Acceptance suite upkeep for DB-AT-002/010/020/021/022/023/024) — **in_progress** (D.1-D.4 complete; D.4 registry audit 2025-12-08T140000Z: 26 Active selectors cross-referenced, 0 orphans/stale entries, 189 tests collected. Workflow Integration cluster certified; DB-AT-010 blocked_pending_upstream. Artifacts: `plans/active/DB-AT-SUITE-CARE-001/reports/2025-12-08T140000Z/`).
