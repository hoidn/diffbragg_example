...
- [ARCH-STAGE-CONTEXT-CONSOLIDATION] (Stage Context Parameter Consolidation) — **in_progress** (2025-12-09T010000Z i=253: Phase B complete; Phase C.1 next — refactor `_build_stage_a_params` signature to use `StageAInputContext`).
