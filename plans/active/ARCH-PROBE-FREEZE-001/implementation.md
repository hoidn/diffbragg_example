...
- [ ] B6: Promote `plans/active/TOOLING-VIS-001/bin/capture_smoke_calibration.py` into a canonical calibration tool so DiffBragg smoke bundles are generated by owner modules rather than a 300+ LOC plan script.
