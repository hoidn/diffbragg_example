...
- [ ] B4: Promote the sigma embedding helper into the production tree so metadata fixtures no longer depend on the 250-line plan script `plans/active/PHYSICS-LOSS-001/bin/embed_sigma_external_lookup.py`.
