...
- [ ] B5: Collapse `plans/active/TOOLING-VIS-001/bin/compare_mapping_dataset_metrics.py` into a thin wrapper over a canonical owner CLI so mapping/calibration diagnostics run inside production modules instead of a 600+ LOC plan script.
