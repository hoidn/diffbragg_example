...
- **Base** (N_cells=1,1,1): 1.756222e+02
- **Scaled** (N_cells=41,29,32): 2.408678e+10

## Scaling Analysis

- **Expected ratio** (Na·Nb·Nc)²: 1,447,650,304.0
- **Observed ratio**: 137,151,105.6
- **Relative error**: 90.53%
- **Deviation factor**: 0.094740x expected
...
- **F_cell**: 1.000000e+02
- **F_latt**: 4.151231e+03
- **intensity_pre_polar**: 9.634716e+14
- **min_abs_delta_h**: 1.525879e-05
- **min_abs_delta_k**: 0.000000e+00
- **min_abs_delta_l**: 0.000000e+00
...
|------|-----|--------|-----|----------------|
| Slow | -0.400000 | 0.000000 | 0.400000 | ✓ |
| Fast | -0.400000 | 0.000000 | 0.400000 | ✓ |
...
| k | -0.040000 | 0.000000 | 0.040000 |
| l | -0.040000 | 0.000000 | 0.040000 |
| h0 | 200 | 200 | 200 |
| k0 | -0 | 0 | -0 |
| l0 | 0 | 0 | 0 |
...
| Δk | -3.725290e-09 | 0.000000e+00 | 3.725290e-09 |
...
- **F_latt_ratio**: 4.151231e+03
- **F_latt_ratio_expected**: 3.804800e+04
- **I_pre_polar_ratio**: 1.371511e+08
- **I_pre_polar_ratio_expected**: 1.447650e+09
- **base_I_pre_polar_over_F_total_sq**: 7.024891e+02
- **scaled_I_pre_polar_over_F_total_sq**: 5.590943e+03
...
- **Total subpixels sampled**: 25
- **Subpixels in central lobe**: 9 (36.00%)
- **Central lobe thresholds**:
  - |Δh| < 0.024390
  - |Δk| < 0.034483
  - |Δl| < 0.031250
- **Intensity share from central lobe**: 92.93%
- **Implied (Na·Nb·Nc)² ratio from coverage**: 1.345232e+09
...
❌ **Contract violation detected**: The observed ratio deviates by 90.5% from expected.

The SQUARE lattice contract (docs/spec-db-core.md:60-140) requires weights ∝ (Na·Nb·Nc)².
This 0.094740x shortfall suggests a bug in the lattice weight computation.
