...
- [x] **D4 — TEST_SUITE_INDEX.md hygiene**: Quarterly audit of TEST_SUITE_INDEX.md to remove stale selectors, update artifact paths, refresh runtime estimates, and sync with TESTING_GUIDE.md §2. ✅ 2025-12-08 (Loop i=187): Audit complete — 26 Active selectors cross-referenced, 0 orphans/stale entries, 189 tests collected. See `reports/2025-12-08T140000Z/test_registry_audit.md`.
