...
def main():
    ...
    out_path = "plans/active/NANOBRAG-GOLDEN-001/reports/2025-10-29T030352Z/golden_dataset/legacy/bragg_diffbragg.npy"
    np.save(out_path, Bragg)
    print(f"Saved DiffBragg Bragg tensor to {out_path}")

    # Save metadata
    meta_path = "plans/active/NANOBRAG-GOLDEN-001/reports/2025-10-29T030352Z/golden_dataset/legacy/metadata.txt"
